    ...
    <div class="separate">
      ...
      <div class="style-4">
        ...
        <ul class="menu-4" v-show="!mobile">
          ...
          <li class="link">
            <div class="dropdown-navigation" @click="toggleDropdown">
              <router-link to="/about">SOLUTION</router-link>
              <!--              <i class='bx bxs-chevron-down'></i>-->
...
<!--          </li>-->
          ...
          <li class="link">
            <div class="dropdown-navigation">
              <router-link to="/contact">RESOURCES</router-link>
              <!--              <i class='bx bxs-chevron-down'></i>-->
              <!--              <div v-if="showDropdown" class="dropdown-content">-->
        ...
        <div>
          <ul class="dropdown-nav" v-show="mobileNav">
            ...
            <label class="accordion-wrapper">
              ...
              <div class="title">
                <div class="title-content">
                  <router-link to="/about"><p @click="toggleMobileNav2" class="title-content-para">PRODUCT </p></router-link>
                </div>
              </div>
            ...
            <label class="accordion-wrapper">
              ...
              <div class="title">
                <div class="title-content">
                  <router-link to="/contact"><p @click="toggleMobileNav2" class="title-content-para">SOLUTION </p></router-link>
                </div>
              </div>
            ...
            <label class="accordion-wrapper">
              ...
              <div class="title">
                <div class="title-content">
                  <router-link to="/press"><p @click="toggleMobileNav2" class="title-content-para">RESOURCES </p></router-link>
                </div>
              </div>
...
<!--            </li>-->
        ...
        <div class="icon">
          <i class='bx bx-menu' v-show="mobile" :class="{'icon-active' : mobileNav}"></i>
        </div>
      </div>
